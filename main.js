...
const createUI = async (city) => {
    ...
    date.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(`${data.location.time}`), 'do MMM, yyyy - hh:mm aaa')
